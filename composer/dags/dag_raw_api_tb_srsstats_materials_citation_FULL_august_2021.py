...
dag = DAG(
    'dag_raw_api_tb_srsstats_materials_citation_FULL_august_2021',
    default_args=default_args,
    description='FULL load on tb_srsstats_materials_citation with monthly dagruns.',
...
params = {
    ...
    'app_engine': {
        ...
        'config': {
            ...
            "dataset": "apis",
            "table_name": "tb_srsstats_materials_citation",
            "delta_fields": [{
                    "name": "DocUploadDate",
                    "value": '"{{ prev_ds }}"-"{{ ds }}"'
                }]
