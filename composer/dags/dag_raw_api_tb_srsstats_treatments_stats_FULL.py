...
dag = DAG(
    'dag_raw_api_tb_srsstats_treatments_stats_FULL',
    default_args=default_args,
    description='FULL load on tb_srsstats_treatments_stats with monthly dagruns.',
...
params = {
    ...
    'app_engine': {
        ...
        'config': {
            ...
            "dataset": "apis",
            "table_name": "tb_srsstats_treatments_stats",
            "delta_fields": [{
                    "name": "DocUploadDate",
                    "value": '"{{ prev_ds }}"-"{{ ds }}"'
                }]
