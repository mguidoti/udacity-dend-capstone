...
dag = DAG(
    'dag_raw_api_tb_diostats_publications_authors_FULL_august_2021',
    default_args=default_args,
    description='FULL load on tb_diostats_publications_authors with monthly dagruns.',
    schedule_interval="@daily",
    tags=['raw', 'api', 'treatment bank', 'FULL', 'production', '@daily'],
    max_active_runs=1
    )
...
params = {
    ...
    'app_engine': {
        ...
        'config': {
            ...
            "dataset": "apis",
            "table_name": "tb_diostats_publications_authors",
            "delta_fields": [{
                    "name": "DocUploadDate",
                    "value": '"{{ prev_ds }}"-"{{ ds }}"'
                }]
    ...
    'data_quality': {
        ...
        'duplicates_table_key': ['DocArticleUuid', 'AuthName']
    }
}
