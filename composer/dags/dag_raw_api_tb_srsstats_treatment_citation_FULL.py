...
dag = DAG(
    'dag_raw_api_tb_srsstats_treatment_citation_FULL',
    default_args=default_args,
    description='FULL load on tb_srsstats_treatment_citation with monthly dagruns.',
    schedule_interval="@weekly",
    tags=['raw', 'api', 'treatment bank', 'FULL', 'production', '@weekly'],
    max_active_runs=1
    )
...
params = {
    ...
    'app_engine': {
        ...
        'config': {
            ...
            "dataset": "apis",
            "table_name": "tb_srsstats_treatment_citation",
            "delta_fields": [{
                    "name": "DocUploadDate",
                    "value": '"{{ prev_ds }}"-"{{ ds }}"'
                }]
