BEGIN
    ...
    DECLARE VAR_PROJECT_ID STRING DEFAULT 'poc-plazi-trusted';
    DECLARE VAR_DATASET STRING DEFAULT 'publications';
    ...
    DECLARE VAR_DELTA_FIELD STRING DEFAULT 'DocUpdateDate';
